...
var SelectableGroup = (_temp = _class = function (_Component) {
	...
	_createClass(SelectableGroup, [{
		...
		value: function processItem(item, tolerance, selectboxBounds, click, enableDeselect, mixedDeselect) {
			...
			var singleItemSelection = this.props.singleItemSelection;
			var dragSelect = this.props.noDragSelect;
			...
			if (click && isCollided) {
				if (selected) {
					...
					if (singleItemSelection && this.selectedItems.size > 0) {
						...
						try {
							for (var _iterator6 = this.selectedItems.values()[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
								var i = _step6.value;
		...
		value: function cleanUp() {
			...
			if (this.props.mixedDeselect) {
				...
				try {
					for (var _iterator7 = this.registry.values()[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
  ...
  */
	...
	singleItemSelection: _react.PropTypes.bool,
	dragSelect: _react.PropTypes.bool
